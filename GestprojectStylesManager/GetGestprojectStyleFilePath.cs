...
{
   public class GetGestprojectStyleFilePath
   {
      ...
      private static string GestprojectStylesFolderPath { get; set; } = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ProgramFilesX86), @"Micad\Gestproject 2020\Styles");
