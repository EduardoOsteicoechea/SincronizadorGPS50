...
namespace SincronizadorGPS50
{
   public class TaxesSynchronizationTableSchemaProvider : ISynchronizationTableSchemaProvider
   {
      ...
      static List<(string columnName, string friendlyName, Type columnType, string columnDefinition, dynamic defaultValue)> ColumnsTuplesItemsProvider = new List<(string, string, Type, string, dynamic)>()
      {
         ...
         ("IMP_ID", $"Id en Gestproject", typeof(int), "INT", null),
         ("IMP_TIPO", "Tipo de impuesto en Gestproject", typeof(string), "VARCHAR(MAX)", string.Empty),
         ("IMP_NOMBRE", "Nombre", typeof(string), "VARCHAR(MAX)", string.Empty),
         ("IMP_DESCRIPCION", "Descripción", typeof(string), "VARCHAR(MAX)", string.Empty),
         ("IMP_VALOR", "Valor", typeof(decimal), "DECIMAL(18,2)", null),
         ("IMP_SUBCTA_CONTABLE", "Subcuenta contable", typeof(string), "VARCHAR(MAX)", string.Empty),
         ("IMP_SUBCTA_CONTABLE_2", "Subcuenta contable 2", typeof(string), "VARCHAR(MAX)", string.Empty),
