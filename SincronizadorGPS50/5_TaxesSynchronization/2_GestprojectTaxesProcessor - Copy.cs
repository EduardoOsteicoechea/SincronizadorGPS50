...
//      public bool WasDeletedFromGestproject { get; set; } = false;
...
//               //WasDeletedFromGestproject = entity.S50_GUID_ID == "" && entity.IMP_SUBCTA_CONTABLE != "" && entity.IMP_SUBCTA_CONTABLE_2 != "";
//               //if(WasDeletedFromGestproject)
//               //{
//               //   DeleteEntity(connection, tableSchema, gestprojectEntites, entity);
//               //   RegisterEntity(connection, tableSchema, entity);
//               //};
//               //MessageBox.Show(entity.IMP_DESCRIPCION +  " - WasDeletedFromGestproject: " + WasDeletedFromGestproject);
...
//            bool neverSynchronized = entity.S50_COMPANY_GROUP_GUID_ID == "" && entity.IMP_SUBCTA_CONTABLE == "" && !WasDeletedFromGestproject;
//            NeverWasSynchronized = neverSynchronized;
...
//            //MustBeUpdated = WasDeletedFromGestproject;
//            //if(MustBeUpdated)
//            //{
...
//         try
//         {
//            //MessageBox.Show("Deleting entity");
