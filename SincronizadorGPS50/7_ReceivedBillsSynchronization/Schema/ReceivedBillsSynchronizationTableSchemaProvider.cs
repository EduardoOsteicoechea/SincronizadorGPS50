...
namespace SincronizadorGPS50
{
   public class ReceivedBillsSynchronizationTableSchemaProvider : ISynchronizationTableSchemaProvider
   {
      ...
      static List<(string columnName, string friendlyName, Type columnType, string columnDefinition)> ColumnsTuplesItemsProvider = new List<(string, string, Type, string)>()
      {
         ...
         ("FCP_ID", $"Id en Gestproject", typeof(int), "INT"),
         ("PAR_DAO_ID", "PAR_DAO_ID", typeof(int), "INT"),
         ("FCP_NUM_FACTURA", "FCP_NUM_FACTURA", typeof(int), "INT"),
         ("FCP_FECHA", "FCP_FECHA", typeof(DateTime), "DATETIME"),
         ("PAR_PRO_ID", "PAR_PRO_ID", typeof(int), "INT"),
         ("FCP_BASE_IMPONIBLE", "FCP_BASE_IMPONIBLE", typeof(decimal), "DECIMAL(18,2)"),
         ("FCP_VALOR_IVA", "FCP_VALOR_IVA", typeof(decimal), "DECIMAL(18,2)"),
         ("FCP_IVA", "FCP_IVA", typeof(decimal), "DECIMAL(18,2)"),
         ("FCP_VALOR_IRPF", "FCP_VALOR_IRPF", typeof(decimal), "DECIMAL(18,2)"),
         ("FCP_IRPF", "FCP_IRPF", typeof(decimal), "DECIMAL(18,2)"),
         ("FCP_TOTAL_FACTURA", "FCP_TOTAL_FACTURA", typeof(decimal), "DECIMAL(18,2)"),
         ("FCP_OBSERVACIONES", "FCP_OBSERVACIONES", typeof(string), "VARCHAR(MAX)"),
