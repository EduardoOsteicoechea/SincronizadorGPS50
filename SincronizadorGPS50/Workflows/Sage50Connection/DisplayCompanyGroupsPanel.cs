...
{
    internal class DisplayCompanyGroupsPanel : ISage50ConnectionUIStateTracker, ISage50ConnectionUIComponent
    {
        ...
        public DisplayCompanyGroupsPanel
        (
        ...
        )
        {
            ...
            SelectEnterpryseGroupLabel.Text = "Seleccione el grupo de empresa";
            ...
            PanelTableLayoutPanel.Controls.Add(ConnectButton, 0, 2);
