...
namespace SincronizadorGPS50
{
   public class CompaniesSynchronizationTableSchemaProvider : ISynchronizationTableSchemaProvider
   {
      ...
      {         
         /*0*/("PAR_ID", $"PAR_ID", typeof(int), "INT", null),
         /*1*/("PAR_NOMBRE", "PAR_NOMBRE", typeof(string), "VARCHAR(MAX)", string.Empty),
         /*2*/("PAR_CIF_NIF", "PAR_CIF_NIF", typeof(string), "VARCHAR(MAX)", string.Empty),
         /*3*/("SageCompanyNumber", "SageCompanyNumber", typeof(string), "VARCHAR(MAX)", string.Empty),
      };
