...
{
   public class GestprojectIssuedBillsProcessor : ISynchronizableEntityProcessor<GestprojectIssuedBillModel, Sage50IssuedBillModel>
   {
      public List<GestprojectIssuedBillModel> ProcessedEntities { get; set; }
      ...
      public List<GestprojectIssuedBillModel> ProcessEntityList
      (
         System.Data.SqlClient.SqlConnection connection,
         ISage50ConnectionManager sage50ConnectionManager,
         ISynchronizationTableSchemaProvider tableSchema,
         List<GestprojectIssuedBillModel> gestprojectEntites,
         List<Sage50IssuedBillModel> sage50Entities
      )
      {
         try
         {
            ProcessedEntities = new List<GestprojectIssuedBillModel>();

            for(int i = 0; i < gestprojectEntites.Count; i++)
            {
               GestprojectIssuedBillModel entity = gestprojectEntites[i];
      ...
      public void AppendSynchronizationTableDataToEntity(SqlConnection connection, ISynchronizationTableSchemaProvider tableSchema, GestprojectIssuedBillModel entity)
      {
         try
         {
            new EntitySynchronizationTable<GestprojectIssuedBillModel>().AppendTableDataToEntity
            (
               connection,
      ...
      public void DetermineEntityWorkflow(SqlConnection connection, ISage50ConnectionManager sage50ConnectionManager, ISynchronizationTableSchemaProvider tableSchema, GestprojectIssuedBillModel entity)
      {
         try
         {
      ...
      public void RegisterEntity(SqlConnection connection, ISynchronizationTableSchemaProvider tableSchema, GestprojectIssuedBillModel entity)
      {
         try
         {
            //StringBuilder stringBuilder = new StringBuilder();
      ...
      public void UpdateEntity(SqlConnection connection, ISynchronizationTableSchemaProvider tableSchema, GestprojectIssuedBillModel entity)
      {
         try
         {
            //StringBuilder stringBuilder = new StringBuilder();
      ...
      public void ValidateEntitySynchronizationStatus(SqlConnection connection, ISynchronizationTableSchemaProvider tableSchema, List<Sage50IssuedBillModel> sage50Entities, GestprojectIssuedBillModel entity)
      {
         try
         {
      ...
      public void DeleteEntity(SqlConnection connection, ISynchronizationTableSchemaProvider tableSchema, List<GestprojectIssuedBillModel> gestprojectEntites, GestprojectIssuedBillModel entity)
      {
         try
         {
      ...
      public void ClearEntitySynchronizationData(GestprojectIssuedBillModel entity, List<(string propertyName, dynamic defaultValue)> entityPropertiesValuesTupleList)
      {
         try
         {
            for(global::System.Int32 i = 0; i < entityPropertiesValuesTupleList.Count; i++)
            {
               typeof(GestprojectIssuedBillModel).GetProperty(entityPropertiesValuesTupleList[i].propertyName).SetValue(entity, entityPropertiesValuesTupleList[i].defaultValue);
            };
         }
         catch(System.Exception exception)
         {
