...
{
   public class ReceivedBillsSynchronizationManager : IEntitySynchronizationManager
   {
      public void Launch
      (
      ...
      )
      {
         try
         {
            ...
            (
               ...
               new TopRowControlsGenerator<GestprojectReceivedBillModel, Sage50ReceivedBillModel>(false),
